      ...
      <div className="mx-auto w-full lg:px-24 max-w-7xl md:px-12 items-center px-8 py-12"> {/* Reduced py-24 to py-12 */}
        <div>
          <div className="text-center max-w-4xl mx-auto">
            <div className="sm:flex sm:justify-center">
              <div className="relative rounded-full py-1 px-3 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                <Link href="/special-thanks" className="font-semibold text-accent-600">
          ...
          <div className="flex justify-center gap-3 mt-10 flex-col sm:flex-row">
            <Link href="/about" className="items-center justify-center h-12 font-medium rounded-xl focus-visible:outline-black focus:outline-none inline-flex duration-200 text-black lg:w-auto px-6 py-3 text-center text-black/80 w-full border">
              About This Project
            </Link>
            <Link href="/post-a-job" className="items-center justify-center h-12 font-medium rounded-xl focus-visible:outline-black focus:outline-none inline-flex bg-black border-2 border-black duration-200 focus-visible:ring-black hover:bg-transparent hover:border-black hover:text-black lg:w-auto px-6 py-3 text-center text-white w-full">
              Post a Job &nbsp; &rarr;
            </Link>
          </div>
        </div>
